...
// 식당 정보 수정
router.patch('/:dinerId', dinersController.findDiner, dinersController.updateDiner)
// 식당 삭제
router.delete('/:dinerId', dinersController.findDiner, dinersController.deleteDiner)
